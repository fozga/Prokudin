...
def handle_key_press(main_window: "MainWindow", event: QKeyEvent) -> bool:
    ...
    if event.key() == Qt.Key.Key_1:
        ...
        main_window.status_handler.set_message("Viewing Red channel", 3000)
    ...
    if event.key() == Qt.Key.Key_2:
        ...
        main_window.status_handler.set_message("Viewing Green channel", 3000)
        update_main_display(main_window)
        event.accept()
        return True
    if event.key() == Qt.Key.Key_3:
        ...
        main_window.status_handler.set_message("Viewing Blue channel", 3000)
        update_main_display(main_window)
        event.accept()
        return True
    if event.key() == Qt.Key.Key_A:
        main_window.show_combined = True
        main_window.status_handler.set_message("Viewing combined RGB channel", 3000)
        update_main_display(main_window)
        event.accept()
        return True
    return False
